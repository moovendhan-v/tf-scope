      ...
      >
        ...
        <div className="flex items-center gap-2.5 px-[11px] py-3.5 border-b border-[var(--tv-border)] flex-shrink-0">
          <button
            ...
            className="w-9 h-9 rounded-[9px] flex items-center justify-center font-display font-extrabold text-[10px] text-white flex-shrink-0 cursor-pointer select-none"
          ...
          <div className="flex items-center gap-2.5 px-2.5 py-2 rounded-lg cursor-pointer hover:bg-[var(--tv-bg4)] transition-colors">
            ...
            {expanded && (
              <div className="animate-fade-in">
                ...
                <div className="text-[9px] text-[var(--tv-purple)]">tf-scope MVP</div>
              </div>
            )}
          </div>
        </div>
