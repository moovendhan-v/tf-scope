  ...
  'inline-flex items-center gap-1 rounded-[5px] border px-[7px] py-0.5 text-[10px] font-bold tracking-[0.4px] uppercase transition-colors',
  {
    variants: {
      variant: {
        ...
        state:   'bg-[rgba(77,184,255,0.1)]   text-[var(--tv-blue)]   border-[rgba(77,184,255,0.3)]',
        ...
        green:   'bg-[rgba(0,224,144,0.1)]    text-[var(--tv-green)]  border-[rgba(0,224,144,0.3)]',
        ws:      'bg-[rgba(0,212,232,0.1)]    text-[var(--tv-cyan)]   border-[rgba(0,212,232,0.3)]',
        ...
        blue:    'bg-[rgba(77,184,255,0.1)]   text-[var(--tv-blue)]   border-[rgba(77,184,255,0.3)]',
